...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference("Saving.count") do
      post savings_url, params: { saving: { amount: @saving.amount, deposit_type: @saving.deposit_type, member_id: @saving.member_id, month: @saving.month, user_id: @saving.user_id } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { amount: @saving.amount, deposit_type: @saving.deposit_type, member_id: @saving.member_id, month: @saving.month, user_id: @saving.user_id } }
